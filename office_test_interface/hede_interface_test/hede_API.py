...
def hede_api(url, data, key):
    ...
    md5.update(datas_str.encode("utf8"))  # 将参数字符串传入
...
if __name__ == '__main__':
    ...
    data = {"channelType": "382", "brand": "华为", "model": "mate30", "color": "亮黑色", "idcard": "327418199005277366",
            "imei": "222892163985629", "price": "4999", "phone": "13717770521", "name": "宋泉震", "city": "北京",

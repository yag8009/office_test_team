...
def last_name(size=1, names=None):
    return random_string(size, names)


def random_zh_name(length):
    """
    随机姓名
    :param length:
    :return:
    ...
    return "{}{}".format(_last, first_name(random.randint(1, length), _last, first_names))


def random_zh_name_r(length):
    r = random.randint(1, length)
    str = random_zh_name(r)
    return str


def random_en_pwd(length):
    """
    随机密码
    :param length:
    :return:
    ...
    # 选中numOfNum个数字
    slcNum = [random.choice(string.digits) for i in range(numOfNum)]  # 选中numOfLetter个字母
    slcLetter = [random.choice(string.ascii_letters) for i in range(numOfLetter)]  # 打乱这个组合
    slcChar = slcNum + slcLetter
    random.shuffle(slcChar)  # 生成密码
    genPwd = "".join([i for i in slcChar])
    return genPwd


def random_en_pwd_r(length):
    r = random.randint(1, length)
    str = random_en_pwd(r)
    return str
...
def random_phone():
    ...
    :return:
    """
    ps = ["139", "138", "137", "136", "135", "134", "178", "170", "188", "187", "183", "182", "159", "158", "157", "152",

...
from api_platform.models import Project, Sign, Environment, Interface, Case, Plan, Report
from django.http import HttpResponseRedirect, HttpResponse, JsonResponse
from django.contrib import messages
# from django.core import serializers
from api_platform.execute import Execute
import time
# import json
...
def project_add(request):
    if request.method == 'POST':
        ...
        if name_same:
            ...
            sign_name = request.POST['sign']
            sign = Sign.objects.get(sign_name=sign_name)
